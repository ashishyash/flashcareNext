    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h1 className="text-3xl font-semibold text-gray-900">Contract Generation</h1>
            <p className="text-gray-600 mt-1">Automated contract creation and management</p>
          </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Contract Generated Successfully</h3>
              <p className="text-sm text-gray-600">Auto-generated preview on Feb 11, 2026 • Contract ID: CON-2026-1847</p>
            </div>
          </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="bg-teal-600 text-white rounded-t-lg p-6 flex justify-between items-start">
              <div>
                <h2 className="text-2xl font-semibold mb-2">Nursing Contract Agreement</h2>
                ...
                <div className="grid grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <p className="font-medium">Duration of strike - Starts Tomorrow 7 AM</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-b-lg shadow-sm p-8">
              ...
              <div className="grid grid-cols-2 gap-8 mb-8">
                <div>
                  ...
                  <p className="text-gray-700 mb-1">123 Main St, Los Angeles, CA 90001</p>
                  <p className="text-gray-700 mb-1">License: RN-CA-485692</p>
                  <p className="text-gray-700">sarah.chen@email.com</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500 mb-2">FACILITY (Employer)</p>
                  <h3 className="text-xl font-semibold mb-3">Memorial Hospital</h3>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="font-semibold text-gray-900">$75/hour + $150/day Housing</p>
              ...
              <div className="space-y-4 mb-8 text-gray-700">
                <p><span className="font-semibold">1. Employment Status:</span> This agreement establishes a temporary employment relationship for the duration specified above.</p>
                <p><span className="font-semibold">2. Duties & Responsibilities:</span> The Nurse agrees to perform professional nursing services in accordance with facility policies and applicable state regulations.</p>
                <p><span className="font-semibold">3. Termination:</span> Either party may terminate this agreement with 72 hours written notice. Immediate termination may occur for cause.</p>
                <p><span className="font-semibold">4. Compliance:</span> The Nurse certifies all credentials, certifications, and licenses are current and valid.</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8">
                ...
                <div>
                  <p className="text-sm text-gray-600 mb-4">Facility Representative</p>
                  <div className="border-b border-gray-300 pb-2 mb-2">
          ...
          <div className="w-80 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-gray-900">2.3 sec</p>
                </div>
                <div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Compliance Verified</h3>
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700">State regulations met</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-sm text-gray-700">Fair labor standards</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-sm text-gray-700">Insurance requirements</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-sm text-gray-700">Legal template approved</span>
                </div>
              </div>
            </div>
          </div>
